...
This directory contains Manifest V3 service worker wiring. Keep it thin: initialize defaults, open onboarding when needed, observe browser events, call `src/shared/` decision logic, send notifications, and perform redirects.
