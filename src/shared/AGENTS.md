...
Keep this directory browser-agnostic whenever possible. Domain matching, schedule evaluation, reminder windows, unlock limits, sleep session ids, default settings, and stats models belong here so they can be tested with Vitest.
