...
一个 Chrome / Edge 浏览器插件：用多个规则组为睡眠、工作和戒断场景建立可执行的网站边界。默认规则组仍是“晚安边界”，但全局品牌已迁移为 FocusGate / 守界。
...
产品需求见 `prd.md`，视觉与文案原则见 `DESIGN.md`，MV3 架构说明见 `docs/architecture.md`，页面内提醒设计见 `docs/reminder-experience.md`。
历史 UI 草图已归档到 `docs/archive/`，不要作为当前实现依据。
